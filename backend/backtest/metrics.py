...
# the A-share/AKShare column: 252 trading days and a 240-minute session. HK
...
_TRADING_DAYS = {
    "auto": 252, "yfinance": 252, "okx": 365, "akshare": 252,
    "ccxt": 365, "binance": 365, "bybit": 365, "gate": 365,
    "mootdx": 252, "futu": 252, "cmc": 252,
}
_BARS_PER_DAY = {
    "1m":  {"auto": 240, "okx": 1440, "yfinance": 390, "akshare": 240, "ccxt": 1440, "binance": 1440, "bybit": 1440, "gate": 1440, "mootdx": 240, "futu": 240, "cmc": 240},
    "5m":  {"auto": 48,  "okx": 288,  "yfinance": 78,  "akshare": 48,  "ccxt": 288,  "binance": 288,  "bybit": 288,  "gate": 288,  "mootdx": 48,  "futu": 48, "cmc": 48},
    "15m": {"auto": 16,  "okx": 96,   "yfinance": 26,  "akshare": 16,  "ccxt": 96,   "binance": 96,   "bybit": 96,   "gate": 96,   "mootdx": 16,  "futu": 16, "cmc": 16},
    "30m": {"auto": 8,   "okx": 48,   "yfinance": 13,  "akshare": 8,   "ccxt": 48,   "binance": 48,   "bybit": 48,   "gate": 48,   "mootdx": 8,   "futu": 8, "cmc": 8},
    "1H":  {"auto": 4,   "okx": 24,   "yfinance": 7,   "akshare": 4,   "ccxt": 24,   "binance": 24,   "bybit": 24,   "gate": 24,   "mootdx": 4,   "futu": 4, "cmc": 4},
    "4H":  {"auto": 1,   "okx": 6,    "yfinance": 2,   "akshare": 1,   "ccxt": 6,    "binance": 6,    "bybit": 6,    "gate": 6,    "mootdx": 1,   "futu": 1, "cmc": 1},
    "1D":  {"auto": 1,   "okx": 1,    "yfinance": 1,   "akshare": 1,   "ccxt": 1,    "binance": 1,    "bybit": 1,    "gate": 1,    "mootdx": 1,   "futu": 1, "cmc": 1},
}


def calc_bars_per_year(interval: str = "1D", source: str = "auto") -> int:
...
def calc_metrics(
    ...
    if bars_per_year is None:
        ...
        calendar_days = (last - first).days  # type: ignore
    ...
    if bench_ret is not None and len(bench_ret) > 0:
        ...
        active_ret = port_ret.sub(bench_ret.reindex(port_ret.index).fillna(0.0))
