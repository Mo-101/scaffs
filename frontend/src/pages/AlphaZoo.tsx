...
function BrowseView() {
  ...
  return (
    <div className="p-4 md:p-8 max-w-6xl mx-auto space-y-8">
        ...
        {ZOO_CARDS.map((z) => {
          ...
          return (
            <button
              ...
              className={cn(
                "glass-surface glass-card text-left rounded-2xl p-4 space-y-2 transition bg-gradient-to-br",
                z.accent,
      ...
      {/* Filter bar */}
      <div className="glass-surface flex flex-col md:flex-row md:items-end gap-3 rounded-2xl p-4">
        <div className="flex-1 min-w-0">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="glass-input text-sm pl-9"
            />
          </div>
        </div>
  ...
  return (
    <div className="p-4 md:p-8 max-w-4xl mx-auto space-y-6">
      ...
      <section className="space-y-2">
        ...
        <pre className="glass-panel rounded-2xl p-4 overflow-x-auto text-xs leading-relaxed">
      ...
      <section className="space-y-2">
        ...
        <details className="glass-surface rounded-2xl group">
          ...
          <pre className="glass-panel border-t border-border/40 p-4 overflow-x-auto text-xs leading-relaxed rounded-b-2xl">
...
function BenchView() {
  ...
  return (
    <div className="p-4 md:p-8 max-w-5xl mx-auto space-y-6">
      ...
      <form
        onSubmit={startBench}
        className="glass-surface rounded-2xl p-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3 items-end"
      >
        <div>
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        {totals.map(({ label, value, icon: Icon, tone }) => (
          <div key={label} className="glass-surface glass-card rounded-2xl p-4 flex items-center gap-3">
...
function CompareView() {
  ...
  return (
    <div className="p-4 md:p-8 max-w-5xl mx-auto space-y-6">
      ...
      <form onSubmit={startCompare} className="glass-surface rounded-2xl p-4 space-y-3">
        <div>
          ...
          <textarea
            ...
            className="glass-textarea text-sm font-mono disabled:opacity-50"
          />
