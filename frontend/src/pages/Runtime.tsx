...
function SummaryTile({ label, value, tone, icon: Icon }: SummaryTileProps) {
  return (
    <div
      className={cn(
        "glass-surface glass-card rounded-2xl p-4 bg-gradient-to-br",
        tone === "success" && "from-success/20 to-success/5",
        tone === "danger" && "from-danger/20 to-danger/5",
        tone === "neutral" && "from-muted/40 to-transparent",
      )}
    >
