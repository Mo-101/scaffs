...
function RunCardStat({ label, value, tone = "normal" }: { label: string; value: string; tone?: "normal" | "warning" }) {
  return (
    <div className="glass-surface glass-card rounded-md p-3">
...
function RunCardPanel({ title, icon: Icon, children }: { title: string; icon: typeof FileCheck2; children: ReactNode }) {
  return (
    <section className="glass-surface glass-card rounded-md p-4">
...
function ChartTab({
  ...
  return (
    <div className="p-4 space-y-4">
        ...
        <div className="glass-surface glass-card rounded-md p-3">
          <div className="flex flex-wrap items-center gap-2">
            ...
            <button
              ...
              className="glass-btn glass-btn--ghost glass-btn--sm text-xs font-medium"
            ...
            <button
              ...
              className="glass-btn glass-btn--accent glass-btn--sm text-xs font-medium"
            ...
            <div className="mt-3 flex flex-wrap gap-2">
              {selectedSymbols.map((symbol) => (
                <button
                  ...
                  className="glass-chip glass-chip--interactive glass-chip--selected text-xs"
                >
                  {symbol} x
                </button>
              ))}
          ...
          {bulkLoading && (
            <div className="mt-3 space-y-1">
              ...
              <div className="glass-progress h-2">
                <div className="glass-progress__fill h-full transition-all" style={{ width: `${progressPercent}%` }} />
              </div>
            </div>
          )}
        </div>
      ...
      {entries.length === 0 && (
        <div className="glass-empty-state rounded-md border border-dashed p-6 text-center text-sm text-muted-foreground">
